...
//                item.add("استرس با فشارخون بالا ارتباط دارد، همچنین استرس می\u200Cتواند سبب ضربان غیرطبیعی قلب، لخته خونی و سختی شریان شود (آترواسکلروزیس). همچنین استرس با مشتریی\u200Cهای شریانی قلب، حملات قلبی و نارسایی قلبی ارتباط دارد.");
